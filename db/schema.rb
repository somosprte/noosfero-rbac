...
ActiveRecord::Schema.define(version: 20181025162837) do
  ...
  create_table "oauth_client_plugin_auths", id: :serial, force: :cascade do |t|
    ...
    t.text "data", default: "--- {}\n"
    t.integer "profile_id"
    t.index ["profile_id"], name: "index_oauth_client_plugin_auths_on_profile_id"
    t.index ["provider_id"], name: "index_oauth_client_plugin_auths_on_provider_id"
    t.index ["provider_user_id"], name: "index_oauth_client_plugin_auths_on_provider_user_id"
